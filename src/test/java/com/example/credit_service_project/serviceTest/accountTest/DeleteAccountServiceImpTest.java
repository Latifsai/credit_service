...
public class DeleteAccountServiceImpTest {
    ...
    @Mock
    private AccountService<DeleteAccountResponse, SearchAccountRequest> service;
    @Test
    public void testDeleteIfAccountExist() {
        var request = new SearchAccountRequest(UUID.fromString("00009999-2222-1111-a456-426655440000"), "A10B3U3OI9");
    ...
    public void testDeleteIfNotFount() {
        var request = new SearchAccountRequest(UUID.fromString("00009999-3332-6776-a446-426655440000"), "A19");
