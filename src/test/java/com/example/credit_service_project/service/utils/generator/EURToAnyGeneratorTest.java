...
class EURToAnyGeneratorTest {
    ...
    @Test
    @DisplayName("Test generateCurrencyMap method")
    ...
    @Test
    @DisplayName("Test generateCurrencyMap method throws NullPointerException")
    void generateCurrencyMapNullPointerException() throws IOException {
        Map<String, Double> currencyMap = new HashMap<>();
        String url = "https://www.ecb.europa.eu/stats/policy_and_exchange_rates/";
        ...
        assertNotEquals(currencyMap, EURToAnyGenerator.generateCurrencyMap());
    }
}