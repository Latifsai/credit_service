...
public class ErrorsMessage {
    ...
    public static final String INAPPROPRIATE_NUMBER_OF_MONTHS_MESSAGE = "IT IS IMPOSSIBLE TO OBTAIN A LOAN FOR THE NUMBER OF MONTHS YOU ENTERED, SELECT IN THE RANGE BETWEEN 12 AND 120 MONTHS!";
    public static final String INAPPROPRIATE_PRINCIPAL_MESSAGE = "PRINCIPAL DOES NOT FIT THE MINIMUM AMOUNT FORMAT!";
