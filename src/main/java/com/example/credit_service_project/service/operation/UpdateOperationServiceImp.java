...
public class UpdateOperationServiceImp implements OperationService<UpdateOperationsResponse, UpdateOperationsRequest> {

    private final OperationRepository repository;
    private final OperationUtils util;

    @Override
    public UpdateOperationsResponse execute(UpdateOperationsRequest request) {
        ...
        return operation.map(o -> {
            ...
            return util.convertUpdatedOperationToUpdateResponse(updatedOperation);
